...
<tr><td>carbide_scout_pci_evaluations_total</td><td>counter</td><td>Number of comparisons between PCI slots in scout&#39;s HardwareInfo and stored boot interface selections, by result.</td></tr>
